...
JuMP implements parameters by a decision variable constrained on creation to a set consisting of a single value, of type [`Parameter`](@ref). For example, this defines two parameters `p[i]` with values 1 and 2, respectively. 
For 
